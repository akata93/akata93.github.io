function Wall(size,x,y){
  var ladrillo = THREE.ImageUtils.loadTexture('brick.jpg');
  THREE.Mesh.call(this, new THREE.BoxGeometry(size,size,size), new THREE.MeshPhongMaterial({map: ladrillo}));
  this.size=size;
  this.position.x=x;
  this.position.z=y;
}
...
THREE.ImageUtils.crossOrigin='';
  ...
  mapa[11]="x            xxx x     x";
  mapa[12]="x  xxxxxxxxxx    x  xxxx"; //se come
 ...
 /*  mapa[0]="xxxxxxxxxxxxxxxxxxxxxxxx";
  ...
  var pasto = THREE.ImageUtils.loadTexture('pasto.jpg');
  var piso = new THREE.Mesh(new THREE.BoxGeometry(30,1,30),new THREE.MeshPhongMaterial({map: pasto}));
  piso.position.y=-1;
  piso.position.y=-1;
...
var environment, camera, renderer, camara, marca=0;
