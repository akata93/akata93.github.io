...
function loop(){
  ...
  obstaculo2 = raycaster2.intersectObject(pelota2);
  obstaculo3 = raycaster3.intersectObjects(cubo2);
  obstaculo4 = raycaster4.intersectObject(pelota1);
  ...
  raycaster1.set(pelota1.position, new THREE.Vector3(1,0,0));
  raycaster2.set(pelota1.position, new THREE.Vector3(-1,0,0));
  raycaster3.set(pelota2.position, new THREE.Vector3(1,0,0));
  raycaster4.set(pelota2.position, new THREE.Vector3(-1,0,0));
